        ...
        start() {
          ...
          for (let i = 0; i < this.listButton.length; i++) {
            ...
            button.node.on(Button.EventType.CLICK, () => {
              ...
              console.log(this.totalUserBetOver + this.totalUserBetUnder + this.listScore[i]);

              if (this.cloneBalanUser >= this.listScore[i] && this.cloneBalanUser >= this.totalUserBetOver + this.totalUserBetUnder + this.listScore[i] && this.balanceUser !== 0 && this.gameEnd === false) {
