  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameCenter", GameCenter = (_dec = ccclass("GameCenter"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(EditBox), _dec5 = property(EditBox), _dec6 = property(EditBox), _dec7 = property(EditBox), _dec8 = property(EditBox), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec(_class = (_class2 = class GameCenter extends Component {
        ...
        register() {
          var username = this.boxNameRes.string;
          var password = this.boxPassRes.string;
          var confirmPassword = this.boxRePassRes.string;
          ...
          var existingAccount = this.registeredAccounts.find(account => account.username === username);
        ...
        login() {
          ...
          var password = this.boxPassLogin.string; // Kiểm tra xem tên người dùng và mật khẩu có khớp với bất kỳ tài khoản nào trong mảng không

          var account = this.registeredAccounts.find(acc => acc.username === username && acc.password === password);

          if (account) {
            this.LoadingNode.active = true;
            var _username = account.username;
            window["loggedInUsername"] = _username;
            director.loadScene("Game");
          } else {
...
//# sourceMappingURL=f5b5d0e2bd1c266681a8c289f4317505b1d1b260.js.map