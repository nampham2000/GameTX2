    ...
    execute: function () {
      ...
      _export("GameC", GameC = (_dec = ccclass("GameC"), _dec2 = property({
        ...
        constructor() {
          ...
          //Lable
          _initializerDefineProperty(this, "UnderLableValueUser", _descriptor29, this);

          _initializerDefineProperty(this, "OverLableValueUser", _descriptor30, this);

          _initializerDefineProperty(this, "totalUnderText", _descriptor31, this);

          _initializerDefineProperty(this, "totalOverText", _descriptor32, this);

          _initializerDefineProperty(this, "countDown", _descriptor33, this);

          _initializerDefineProperty(this, "countDownResult", _descriptor34, this);

          _initializerDefineProperty(this, "countPlayerOverLb", _descriptor35, this);

          _initializerDefineProperty(this, "countPlayerUnderLb", _descriptor36, this);

          _initializerDefineProperty(this, "BalanceNumber", _descriptor37, this);

          _initializerDefineProperty(this, "ToatalDice", _descriptor38, this);

          //BUTTON
          _initializerDefineProperty(this, "value1k", _descriptor39, this);

          _initializerDefineProperty(this, "value10k", _descriptor40, this);

          _initializerDefineProperty(this, "value50k", _descriptor41, this);

          _initializerDefineProperty(this, "value100k", _descriptor42, this);

          _initializerDefineProperty(this, "value500k", _descriptor43, this);

          _initializerDefineProperty(this, "value10M", _descriptor44, this);

          _initializerDefineProperty(this, "value50M", _descriptor45, this);

          _initializerDefineProperty(this, "unDice1His", _descriptor46, this);

          _initializerDefineProperty(this, "unDice2His", _descriptor47, this);

          _initializerDefineProperty(this, "unDice3His", _descriptor48, this);

          _initializerDefineProperty(this, "page2Button1", _descriptor49, this);

          _initializerDefineProperty(this, "page2Button2", _descriptor50, this);

          _initializerDefineProperty(this, "dice1", _descriptor51, this);

          _initializerDefineProperty(this, "diceHis", _descriptor52, this);

          _initializerDefineProperty(this, "imageNodes", _descriptor53, this);

          _initializerDefineProperty(this, "imageNodesDiceRes", _descriptor54, this);

          _initializerDefineProperty(this, "imageNodesResult", _descriptor55, this);

          _initializerDefineProperty(this, "imageNodesResultHistory", _descriptor56, this);

          _initializerDefineProperty(this, "NumberNodesResultHistory", _descriptor57, this);

          _initializerDefineProperty(this, "ListDice1Node", _descriptor58, this);

          _initializerDefineProperty(this, "ListDice2Node", _descriptor59, this);

          _initializerDefineProperty(this, "ListDice3Node", _descriptor60, this);

          _initializerDefineProperty(this, "LableChat", _descriptor61, this);

          _initializerDefineProperty(this, "listSpriteResult", _descriptor62, this);

          _initializerDefineProperty(this, "listSpriteResultHistory", _descriptor63, this);

          _initializerDefineProperty(this, "listSpritetNumberHistory", _descriptor64, this);

          _initializerDefineProperty(this, "editBoxChat", _descriptor65, this);
        ...
        start() {
          ...
          this.createNodeDice3History(); // this.handleEvent();
        ...
        chatAppear() {
          ...
          this.unchat.active = true; // tween(this.Chat)
          //   .to(0.3, {
        ...
        handleEvent() {
          ...
          for (var i = this.LableChat.length - 1; i > 0; i--) {
        ...
        doubleBet() {
          if (this.checkOver === true && this.totalUserBetOver * 2 <= this.cloneBalanUser && this.totalUserBetOver * 2 <= this.balanceUser) {
            this.totalUserBetOver = this.totalUserBetOver * 2;
            this.clonetotalUserBetOver = this.totalUserBetOver;
            this.OverLableValueUser.string = this.totalUserBetOver.toString();
          }

          if (this.checkUnder === true && this.totalUserBetUnder * 2 <= this.cloneBalanUser) {
        ...
        writable: true,
        initializer: null
      }), _descriptor29 = _applyDecoratedDescriptor(_class2.prototype, "UnderLableValueUser", [_dec30], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor30 = _applyDecoratedDescriptor(_class2.prototype, "OverLableValueUser", [_dec31], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor31 = _applyDecoratedDescriptor(_class2.prototype, "totalUnderText", [_dec32], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor32 = _applyDecoratedDescriptor(_class2.prototype, "totalOverText", [_dec33], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor33 = _applyDecoratedDescriptor(_class2.prototype, "countDown", [_dec34], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor34 = _applyDecoratedDescriptor(_class2.prototype, "countDownResult", [_dec35], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor35 = _applyDecoratedDescriptor(_class2.prototype, "countPlayerOverLb", [_dec36], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor36 = _applyDecoratedDescriptor(_class2.prototype, "countPlayerUnderLb", [_dec37], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor37 = _applyDecoratedDescriptor(_class2.prototype, "BalanceNumber", [_dec38], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor38 = _applyDecoratedDescriptor(_class2.prototype, "ToatalDice", [_dec39], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor39 = _applyDecoratedDescriptor(_class2.prototype, "value1k", [_dec40], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor40 = _applyDecoratedDescriptor(_class2.prototype, "value10k", [_dec41], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor41 = _applyDecoratedDescriptor(_class2.prototype, "value50k", [_dec42], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor42 = _applyDecoratedDescriptor(_class2.prototype, "value100k", [_dec43], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor43 = _applyDecoratedDescriptor(_class2.prototype, "value500k", [_dec44], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor44 = _applyDecoratedDescriptor(_class2.prototype, "value10M", [_dec45], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor45 = _applyDecoratedDescriptor(_class2.prototype, "value50M", [_dec46], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor46 = _applyDecoratedDescriptor(_class2.prototype, "unDice1His", [_dec47], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor47 = _applyDecoratedDescriptor(_class2.prototype, "unDice2His", [_dec48], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor48 = _applyDecoratedDescriptor(_class2.prototype, "unDice3His", [_dec49], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor49 = _applyDecoratedDescriptor(_class2.prototype, "page2Button1", [_dec50], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor50 = _applyDecoratedDescriptor(_class2.prototype, "page2Button2", [_dec51], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor51 = _applyDecoratedDescriptor(_class2.prototype, "dice1", [_dec52], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor52 = _applyDecoratedDescriptor(_class2.prototype, "diceHis", [_dec53], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor53 = _applyDecoratedDescriptor(_class2.prototype, "imageNodes", [_dec54], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor54 = _applyDecoratedDescriptor(_class2.prototype, "imageNodesDiceRes", [_dec55], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor55 = _applyDecoratedDescriptor(_class2.prototype, "imageNodesResult", [_dec56], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor56 = _applyDecoratedDescriptor(_class2.prototype, "imageNodesResultHistory", [_dec57], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor57 = _applyDecoratedDescriptor(_class2.prototype, "NumberNodesResultHistory", [_dec58], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor58 = _applyDecoratedDescriptor(_class2.prototype, "ListDice1Node", [_dec59], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor59 = _applyDecoratedDescriptor(_class2.prototype, "ListDice2Node", [_dec60], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor60 = _applyDecoratedDescriptor(_class2.prototype, "ListDice3Node", [_dec61], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor61 = _applyDecoratedDescriptor(_class2.prototype, "LableChat", [_dec62], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor62 = _applyDecoratedDescriptor(_class2.prototype, "listSpriteResult", [_dec63], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor63 = _applyDecoratedDescriptor(_class2.prototype, "listSpriteResultHistory", [_dec64], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor64 = _applyDecoratedDescriptor(_class2.prototype, "listSpritetNumberHistory", [_dec65], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor65 = _applyDecoratedDescriptor(_class2.prototype, "editBoxChat", [_dec66], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=48f7b8103526d9c791cd8c00a78108deb2c565e4.js.map