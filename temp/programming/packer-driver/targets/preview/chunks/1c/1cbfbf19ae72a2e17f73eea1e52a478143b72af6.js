    ...
    execute: function () {
      ...
      _export("GameC", GameC = (_dec = ccclass("GameC"), _dec2 = property({
        ...
        createGrid() {
          ...
          var prefabType = this.sum <= 10 ? this.Under : this.Over; // Kiểm tra nếu đã đủ hàng
          ...
          var posX = this.currentCol * this.cellWidth; // Tính vị trí x dựa trên chỉ mục cột hiện tại

          var posY = -this.currentRow * this.cellHeight; // Tính vị trí y dựa trên chỉ mục hàng hiện tại
